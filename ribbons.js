 ...
 * Modified for increased animation speed as requested.
 */
...
})( "Ribbons", function()
{
    ...
    var Factory = function( options )
    {
        ...
        this._options = {
            ...
            parallaxAmount : -0.3,
            // add animation effect to each ribbon section over time - ENHANCED
    ...
    Factory.prototype = {
        ...
        _drawRibbonSection: function( section )
        {
            if( section )
            {
                ...
                else { section.delay -= 1.0; } // Even faster delay reduction
        ...
        _onDraw: function()
        {
            ...
            for( var i = this._ribbons.length - 1; i >= 0; i-- )
            {
                ...
                {
                    var section = ribbon[ s ];
                    if( this._drawRibbonSection( section ) !== true ) done = false;
                }
                // remove ribbon if all sections are done
                if( done ) { this._ribbons.splice( i, 1 ); }
            }
